...
const Header = () => {
  ...
  // Get cart items count and total amount
      ...
      >
        ...
        <div className="md:hidden flex justify-between items-center px-3 py-2">
          ...
          <div className="flex-1 flex justify-center">
            <img className="h-10" src="/Assets/BiharEssence.jpeg" alt="Logo" />
          </div>

          {/* Cart - Right */}
          <Link
            to="/cart"
            className="flex items-center gap-1 px-2 py-1 rounded-lg border border-green-500 bg-green-50"
          >
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <li className="flex items-center">
                    <Link
                      to="/cart"
                      className="flex items-center gap-2 px-2 py-1 rounded-lg border border-green-500 bg-green-50 hover:bg-green-100 transition-all"
                    >
                  ...
                  <li className="px-2">
                    <Link
                      ...
                      className={`flex items-center gap-2 px-3 py-2 rounded-lg border-2 ${
                        isDark
                          ? "border-pink-500 bg-pink-900/20 hover:bg-pink-900/40"
                      ...
                      <div className="flex flex-col items-start">
                        <span
                          className={`text-xs font-semibold ${
                            isDark ? "text-pink-300" : "text-green-700"
                          }`}
                        >
                          {cartCount} {cartCount === 1 ? "item" : "items"}
                        </span>
                        <span
                          className={`text-sm font-bold ${
                            isDark ? "text-pink-200" : "text-green-900"
                          }`}
                        >
                          ₹{cartTotal.toFixed(2)}
                        </span>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-300">
            {isAuthenticated ? (
              <ul className="flex flex-col p-2">
                <li className="py-3 px-4 border-b border-gray-200 flex justify-center">
                  <button
                    onClick={handleThemeToggle}
